"""
Django settings for FarmaGo project.
...
SECRET_KEY = 'django-insecure-l%u#-0xr+^d*093z#s5lm46ddi970c@ee&7j$*133m9=1*&)fm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.orders.utils.cart_context_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'FarmaGo.wsgi.application'
...
STATIC_URL = "static/"  # ya debería estar
import os
